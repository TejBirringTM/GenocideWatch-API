...
export interface Evidence extends Base {
  ...
  "objectPath": string;
  "producedDateTime"?: Date | null;
  "producedGeoCoord"?: [number, number] | null;
  "title": string;
  "authors": Individual[];
...
export interface OnlinePresence extends std.$Object {
  "email"?: string | null;
  ...
  "patreon"?: string | null;
  "rumble"?: string | null;
  "twittter"?: string | null;
  "website"?: string | null;
}
export interface Individual extends Base, OnlinePresence {
  "name": string;
  "authored": Evidence[];
}
export interface Organisation extends Base, OnlinePresence {
  "name": string;
  "produced": Evidence[];
}
