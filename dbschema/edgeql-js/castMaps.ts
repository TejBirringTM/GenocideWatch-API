...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$IncidentType ? _default.$IncidentType : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _default.$UserRole ?
    ...
    never
  :
  A extends _default.$IncidentType ?
    B extends _default.$IncidentType ?
    B
    :
    never
  :
  A extends _default.$EvidenceType ?
    B extends _default.$EvidenceType ?
    B
    :
    never
  :
  A extends _default.$ContentType ?
    B extends _default.$ContentType ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::IncidentType") {
    if(b.__name__ === "default::IncidentType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::EvidenceType") {
    if(b.__name__ === "default::EvidenceType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ContentType") {
    if(b.__name__ === "default::ContentType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
